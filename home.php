...
<div class="bg-gray-900">
   .
   .
<div class="w-full mt-72 bg-gray-900">
  <div class="p-0 flex items-center text-xl overflow-hidden min-h-screen-75">
    <div class=" mx-auto px-4">
      <div class="items-center text-left flex flex-wrap -mx-4">
        <div class="px-4  text-white w-full lg:w-6/12">
          <h1 class="text-7xl text font-bold leading-tight ">Read with us,to speed your development...</h1>
